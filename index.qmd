...
The goal here is to demonstrate the feasability of numerical simulations of a new *all-topology* two-fluid model using a standard first-order finite-volume scheme.
...
The model has been implemented without the contributions related to the lift forces. We refer to the for a complete description of the model.
...
Three types of test cases are available, a one-dimensional Riemann problem, a two-dimensional Riemann problem and a two-dimensional underwater explosion case.<br>
