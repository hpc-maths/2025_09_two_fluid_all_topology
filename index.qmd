...
This code is based on the open-source **[samurai](https://github.com/hpc-maths/samurai/)** library, which needs to be installed.
Please, find the source codes and post-processing scripts used to generate the data at <br>
<https://github.com/hpc-maths/2025_09_two_fluid_all_topology> <br>
All the instructions on how to generate the data are provided in README.md.
