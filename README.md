...
In order to build the executable, please first install ```samurai``` following the instructions at https://github.com/hpc-maths/samurai. Please, include ```nlohmann```in your environment
